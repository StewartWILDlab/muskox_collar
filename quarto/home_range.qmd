...
print(musk_var[[1]]@info$identity);print(summary(fit706)); plot(musk_var[[1]], CTMM = fit706, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[1]], CTMM = fit706, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)
print(musk_var[[2]]@info$identity);print(summary(fit708)); plot(musk_var[[2]], CTMM = fit708, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[2]], CTMM = fit708, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)
print(musk_var[[3]]@info$identity);print(summary(fit7010)); plot(musk_var[[3]], CTMM = fit7010, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[3]], CTMM = fit7010, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)
print(musk_var[[4]]@info$identity);print(summary(fit7011)); plot(musk_var[[4]], CTMM = fit7011, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[4]], CTMM = fit7011, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)
print(musk_var[[5]]@info$identity);print(summary(fit7012)); plot(musk_var[[5]], CTMM = fit7012, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[5]], CTMM = fit7012, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)
print(musk_var[[6]]@info$identity);print(summary(fit7013)); plot(musk_var[[6]], CTMM = fit7013, col.CTMM=c("red","purple","blue", "green"),fraction=0.5,level=0.5);plot(musk_var[[6]], CTMM = fit7013, col.CTMM=c("red","purple","blue", "green"),xlim = xlim,,level=0.5)

akde <- akde(musk_tel[[1]],fit706)
EXT <- extent(akde, level=0.95)
COL <- color(musk_tel[[1]],by='time')
plot(musk_tel[[1]],UD=akde,
     xlim=EXT$x,ylim=EXT$y,
     col = COL, lwd=4)
...
set.seed(1)
musk_sim <- simulate(fit7010[[1]], t=musk_tel[[3]]$t)
var_sim <- variogram(musk_sim)
plot(var_sim, CTMM = fit7010[[1]],fraction = 0.5, level = 0.5, col = "blue");title("Simulated 1")
plot(musk_var[[3]], CTMM = fit7010[[1]],fraction = 0.5, level = 0.5);title("Real")
plot(var_sim, CTMM = fit7010[[1]],xlim = xlim, level = 0.5, col = "blue");title("Simulated")
plot(musk_var[[3]], CTMM = fit7010[[1]],xlim = xlim, level = 0.5);title("Real")
```
...
ud <- occurrence(musk_tel[[1]],best_fit[[1]])
plot(musk_tel[[1]],UD=ud,
       lwd=1)

...
season_loc <- tibble(Id_Number = 706, 
                     start_date = c("2007-12-03 16:00:00",
                                    "2008-05-05 00:00:00",
                                    "2008-10-25 00:00:00",
                                    "2009-05-01 16:00:00"),
                     end_date = c("2008-05-05 00:00:00",
                                  "2008-10-25 00:00:00",
                                  "2009-05-01 16:00:00",
                                  "2009-09-01 16:00:00"),
                     season = c("Winter", "Summer", "Winter", "Summer")) %>%
  bind_rows(tibble(Id_Number = 707, 
                   start_date = c("2007-12-03 16:00:00"),
                   end_date = c("2008-01-09 16:00:00"),
                   season = c("Winter"))) %>%
  bind_rows(tibble(Id_Number = 708, 
                   start_date = c("2009-02-24 00:00:00",
                                  "2009-05-09 00:00:00",
                                  "2009-10-25 00:00:00",
                                  "2010-05-06 08:00:00",
                                  "2010-11-16 16:00:00"),
                   end_date = c("2009-05-09 00:00:00",
                                "2009-10-25 00:00:00",
                                "2010-05-06 08:00:00",
                                "2010-11-16 16:00:00",
                                "2010-12-09 08:00:00"),
                   season = c("Winter", "Summer", "Winter", 
                              "Summer", "Winter"))) %>%
  bind_rows(tibble(Id_Number = 709, 
                   start_date = c("2008-01-20 00:00:00"),
                   end_date = c("2008-03-21 16:00:00"),
                   season = c("Winter"))) %>%
  bind_rows(tibble(Id_Number = 710, 
                   start_date = c("2008-01-20 00:00:00"),
                   end_date = c("2008-04-09 16:00:00"),
                   season = c("Winter"))) %>%
  bind_rows(tibble(Id_Number = 7010, 
                   start_date = c("2009-02-09 08:00:00",
                                  "2009-05-15 00:00:00",
                                  "2009-10-22 08:00:00"),
                   end_date = c("2009-05-15 00:00:00",
                                "2009-10-22 08:00:00",
                                "2010-01-19 16:00:00"),
                   season = c("Winter", "Summer", "Winter"))) %>%
  bind_rows(tibble(Id_Number = 7011, 
                   start_date = c("2009-02-04 08:00:00",
                                  "2009-05-04 00:00:00",
                                  "2009-11-18 00:00:00",
                                  "2010-04-29 00:00:00",
                                  "2010-11-14 00:00:00",
                                  "2011-05-21 00:00:00",
                                  "2011-09-28 00:00:00"),
                   end_date = c("2009-05-04 00:00:00",
                                "2009-11-18 00:00:00",
                                "2010-04-29 00:00:00",
                                "2010-11-14 00:00:00",
                                "2011-05-21 00:00:00",
  ...
  bind_rows(tibble(Id_Number = 7012, 
                   start_date = c("2009-02-08 00:00:00",
                                  "2009-05-19 08:00:00",
                                  "2009-10-20 16:00:00",
                                  "2010-05-03 08:00:00",
                                  "2010-11-26 16:00:00",
                                  "2011-05-24 00:00:00",
                                  "2011-10-26 08:00:00"),
                   end_date = c("2009-05-19 08:00:00",
                                "2009-10-20 16:00:00",
                                "2010-05-03 08:00:00",
                                "2010-11-26 16:00:00",
                                "2011-05-24 00:00:00",
                   ...
                   season = c("Winter", "Summer", "Winter", 
                              "Summer", "Winter","Summer", "Winter"))) %>%
  bind_rows(tibble(Id_Number = 7013, 
                   start_date = c("2009-02-17 00:00:00",
                                  "2009-05-21 00:00:00",
                                  "2009-10-17 00:00:00",
                                  "2010-05-11 00:00:00",
                                  "2010-11-26 16:00:00",
                                  "2011-05-21 16:00:00"),
                   end_date = c("2009-05-21 00:00:00",
                                "2009-10-17 00:00:00",
                                "2010-05-11 00:00:00",
                                "2010-11-26 16:00:00",
                                "2011-05-21 16:00:00",
  ...
  bind_rows(tibble(Id_Number = 7080, 
                   start_date = c("2007-12-03 16:00:00",
                                  "2008-05-10 00:00:00",
                                  "2008-10-18 08:00:00",
                                  "2009-05-09 16:00:00"),
                   end_date = c("2008-05-10 00:00:00",
                                "2008-10-18 08:00:00",
                                "2009-05-09 16:00:00",
                                "2009-09-01 16:00:00"),
                   season = c("Winter", "Summer", "Winter", "Summer"))) %>%
...
loc_func <- function(id, date){
  season = season_loc %>% 
           filter(Id_Number == id,
                  start_date<=date,
                  end_date>date) %>%
           pull(season)
  if (length(season)==0){season = NA}
  return(season)
}
...
musk_season <- musk_collar_filt %>%
  ...
  rowwise() %>%
  left_join(season_loc, relationship = "many-to-many") %>%
  filter(start_date<=datetime,
         end_date>datetime) %>%
  mutate(season = case_when(
    month>=4&season=="Winter"&month<=5~"Calving",
    TRUE~season))

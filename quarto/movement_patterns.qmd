...
season_end <- musk_migstart %>%
  ...
  filter(Id_Number==706&datetime%in%as_datetime(c("2008-05-05 00:00:00",
                                                  "2009-05-02 16:00:00"))|
         Id_Number==710&datetime%in%as_datetime(c("2008-04-10 16:00:00"))|
         Id_Number==709&datetime%in%as_datetime(c("2008-03-22 16:00:00"))|
         Id_Number==707&datetime%in%as_datetime(c("2008-01-10 16:00:00"))|
         Id_Number==7010&datetime%in%as_datetime(c("2010-01-20 16:00:00",
                                                   "2009-05-15 00:00:00"))|
...
musk_season <- musk_collar_filt %>%
  ...
  mutate(season = case_when(
    ...
    datetime<season_start~"Summer",
    datetime>=season_end~"Summer",
    month>=4&month<=5~"Calving",
    TRUE~"Winter")) %>%
